...
function dvwaPageReload() {
	...
	dvwaRedirect( xss_filter($_SERVER[ 'PHP_SELF' ]) );
...
return $guestbook;
	...
	function xss_filter($input) {
		...
		$fine = htmlentities($input, ENT_QUOTES, 'UTF-8');
	...
	define( 'DVWA_LEVEL_HIGH_HEADERS', '../../dvwa/includes/dvwaHeaders.php' );
// -- END
?>
